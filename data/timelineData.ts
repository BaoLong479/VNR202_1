...
export const TIMELINE_DATA: TimelineEvent[] = [
  ...
  },
  {
    ...
    image_description:
      "Toàn cảnh Đại hội đại biểu toàn quốc lần thứ VII của Đảng, nơi thông qua Cương lĩnh 1991 lịch sử.",
    imageUrl:
      "https://images.unsplash.com/photo-1581092921440-daef33b37018?q=80&w=1200&auto=format&fit=crop",
    quiz: [
      {
        question:
